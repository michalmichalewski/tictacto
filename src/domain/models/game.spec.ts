...
describe('Game entity', () => {
    ...
    describe('Player', () => {
        ...
        it('should be able to make a move ', function () {
            ...
            expect(game.getState()).toBe(State.IN_PROGRESS);
